...
--
-- Host: localhost    Database: dbms_database (updated)
-- ------------------------------------------------------
...
CREATE DATABASE IF NOT EXISTS `dbms_database` CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `dbms_database`;
--
...
--
-- Final closing statements for the dump
--
...
--
-- Additional schema modifications requested
--

ALTER TABLE claim
ADD COLUMN risk_score INT DEFAULT 0;

-- Note: The following commands assume a table named 'workflow_steps' exists in your schema.
-- This table was not defined in the provided script, so these may fail if it doesn't exist.
